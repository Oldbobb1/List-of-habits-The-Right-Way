...
//            make.centerY.equalToSuperview().offset(-70) // -50 - guidePrew2
//            make.width.equalTo(370)
//            make.height.equalTo(490) // 450 - guidePrew2
//        })
        
        Layout.applyView(label, view: view, leadingOffset: 10, trailingOffset: -10, bottomOffset: -110 )
