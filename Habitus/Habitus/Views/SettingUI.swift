...
//    
//    func layout() {
//        Layout.applyView(titleLabel, view: self, topOffset: 0, leadingOffset: 10, trailingOffset: -10)
//        
//        Layout.applyView(settingTableView, view: self, leadingOffset: 0 , trailingOffset: 0, bottomOffset: 0, additionalConstraints:{ make in
//            make.top.equalTo(self.titleLabel.snp.bottom).offset(20)
